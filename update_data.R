...
df_rp_penalty <-
  ...
  filter(!(matchup_id == 20 & player == 'Mitch Farris')) %>%
...
team_points <- 
  ...
  mutate('weight' = case_when(
    ...
    matchup_id == 15 & params$season == 2026 ~ 10/7,
  ...
  mutate("adj_pts" = case_when(
    ...
    matchup_id == 15 & params$season == 2026 ~ total_points * 7/10,
  ...
  mutate("adj_batting_pts" = case_when(
    ...
    matchup_id == 15 & params$season == 2026 ~ batting_points * 7/10,
  ...
  mutate("adj_pitching_pts" = case_when(
    ...
    matchup_id == 15 & params$season == 2026 ~ pitching_points * 7/10,
  ...
  mutate("adj_sp_pts" = case_when(
    ...
    matchup_id == 15 & params$season == 2026 ~ sp_points * 7/10,
