...
gt_trades <- 
  ...
  tab_footnote(footnote = "Value = Points/Week vs. League Average at Position",
               locations = cells_column_labels(columns = contains('avg'))) %>% 
  tab_source_note(paste("SP:", sprintf('%0.2f', scale_factors$n_sp), 'Games/Week')) %>% 
  tab_source_note(paste("RP:", sprintf('%0.2f', scale_factors$n_rp), 'Games/Week')) %>% 
  tab_source_note(paste("Batter:", sprintf('%0.2f', scale_factors$n_bat), 'Games/Week')) %>% 
